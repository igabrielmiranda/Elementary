...
void LuaScriptInterface::registerEnums(lua_State* L)
{
	...
	REGISTER_ENUM(L, CONST_SLOT_STORE_INBOX);
	...
	REGISTER_ENUM(L, SKILL_FIRST);
	REGISTER_ENUM(L, SKILL_LAST);
	...
	REGISTER_ENUM(L, BUFF_EXAMPLE);
	REGISTER_ENUM(L, BUFF_UTANI_HUR);
	REGISTER_ENUM(L, BUFF_UTANI_GRAN_HUR);
	REGISTER_ENUM(L, BUFF_UTAMO_VITA);
	REGISTER_ENUM(L, BUFF_UTAMO_TEMPO_SAN);
	REGISTER_ENUM(L, BUFF_UTURA);
	REGISTER_ENUM(L, BUFF_UTAMO_TEMPO);
	REGISTER_ENUM(L, BUFF_UTANA_VID);
	REGISTER_ENUM(L, BUFF_UTURA_GRAN);
	REGISTER_ENUM(L, BUFF_UTANI_TEMPO_HUR);
	REGISTER_ENUM(L, BUFF_LAST);
}
