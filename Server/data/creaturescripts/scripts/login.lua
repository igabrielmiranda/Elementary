...
if resetStorage then
	...
	if player:getStorageValue(231201) < 1 then
	player:popupFYI("\nUpdate v3.2.5\n\nNew Dungeon: Rootkraken\nNew Items: Amber (crafting)\nNew Crafting Ressources: Exalted Core\nNew System: Soulpit\nSoul cores are lootable from Rotten Blood\nand Soulwar monsters, you can challenge this monsters at this moment.\nSoulpit shortcut added on Tp island.\n\nDon\'t forget to update your client!\n\nTeam Exodus")
	player:setStorageValue(231201, 1)
	end
...
for i = 1, #events do
	...
	player:sendTextMessage(MESSAGE_STATUS_CONSOLE_RED, 'Familiar: To summon a Familiar (Level 200) use: !summonfamiliar. To configure the Autoloot, Ctrl + Right Click on your Backpack.')
	-- Promotion
