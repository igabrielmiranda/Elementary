...
slotLib.conditions = {
 ...
 ["LifeLeechChance"] = { Type = CONDITION_ATTRIBUTES, Attr = CONDITION_PARAM_SPECIALSKILL_LIFELEECHCHANCE },
 ["LifeLeechAmount"] = { Type = CONDITION_ATTRIBUTES, Attr = CONDITION_PARAM_SPECIALSKILL_LIFELEECHAMOUNT },
 ["ManaLeechChance"] = { Type = CONDITION_ATTRIBUTES, Attr = CONDITION_PARAM_SPECIALSKILL_MANALEECHCHANCE },
 ["ManaLeechAmount"] = { Type = CONDITION_ATTRIBUTES, Attr = CONDITION_PARAM_SPECIALSKILL_MANALEECHAMOUNT },
...
slotLib.addItemSlot = function(item)
 ...
 item:setCustomAttribute("rarity", 5)
...
function slotAction.onUse(player, item, fromPos, target, toPos, isHotkey)
 ...
 target:getPosition():sendMagicEffect(greatz and 211 or 212)
 player:say(greatz and ":)" or ":(")
 item:remove(1)
 return true
end
