...
// end
?>
<div class="donate-page__title" style="color:white">Admin Page</div><br></br>
...
<ul>
<div class="hts__block-files-title">
		...
		<form type="submit" action="" method="post">
			...
			<input type="text" name="del_name" placeholder="Character name..." style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
		</form>
</div><br>
	<div class="hts__block-files-title">
		...
		<form action="" method="post">
			...
			<table>
				...
				<tr>
					<td>
						<input type="text" name="ban_char" placeholder="Character name..." style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
					</td>
				</tr>
				...
				<tr>
					<td>
						<select name="ban_type" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
							<?php
						...
						<select name="ban_action" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
							<?php
						...
						<select name="ban_time" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
							<?php
				...
				<!-- row 3 -->
				<tr>
					<td><div class="hts__block-files-title">
						Ban reason:</div>
						<select name="ban_reason" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
							<?php
				...
				<tr>
					<td>
					<div class="hts__block-files-title">Violation comment: (max 60 cols).</div>
						<input type="text" name="ban_comment" maxlength="60" placeholder="Ban for botting rotworms." style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
						<button type="submit" value="Set Violation" class="btn gray flex-cc main-content__title-button">Set Violation</button>
					</td>
				</tr>
			</table>
		</form>
		...
		<form action="" method="post">
			<input type="hidden" name="csrf_token" value="<?php echo hhb_tohtml($_SESSION['csrf_token']);?>" />
			<input type="text" name="reset_pass" placeholder="Character name" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
			<input type="text" name="new_pass" placeholder="New password" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
			<button type="submit" value="Change Password" class="btn gray flex-cc main-content__title-button">Change Password</button>
		</form>
						</div><br></br>
	<div class="hts__block-files-title">
		...
		<form action="" method="post">
			<input type="hidden" name="csrf_token" value="<?php echo hhb_tohtml($_SESSION['csrf_token']);?>" />
			<input type="text" name="position_name" placeholder="Character name" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
			<select name="position_type" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
				<?php
				foreach ($config['ingame_positions'] as $key=>$value) {
			...
			<button type="submit" value="Set Position" class="btn gray flex-cc main-content__title-button">Set Position</button>
		</form>
			</div><br></br>
			<div class="hts__block-files-title">
		...
		<form action="" method="post">
			<input type="hidden" name="csrf_token" value="<?php echo hhb_tohtml($_SESSION['csrf_token']);?>" />
			<input type="text" name="points_char" placeholder="Character name" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
			<input type="text" name="points_value" placeholder="Points" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
			<button type="submit" value="Give Points" class="btn gray flex-cc main-content__title-button">Give Points</button>
		</form>
			</div><br></br>
			<div class="hts__block-files-title">
		<b>Teleport Player</b>
		<form action="" method="post">
			...
			<table>
				<tr>
					<td><div class="hts__block-files-title">Type:</div></td>
					<td>
						<select name="from" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
				...
				<tr>
					<td><div class="hts__block-files-title">Player</div></td>
					<td><input type="text" name="player_name" placeholder="Player Name" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;"></td>
				</tr>
				<tr>
					<td><div class="hts__block-files-title">To</div></td>
					<td>
						<select name="to" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
				...
				<tr>
					<td><div class="hts__block-files-title">Town</div></td>
					<td>
					<select name="town" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
						<?php
				...
				<tr>
					<td><div class="hts__block-files-title">Position</div></td>
					<td>
						<input type="text" name="x" placeholder="Position X" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
						<input type="text" name="y" placeholder="Position Y" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
						<input type="text" name="z" placeholder="Position Z" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;">
					</td>
				</tr>

				<tr>
					<td></td>
					<td><button type="submit" value="teleport" class="btn gray flex-cc main-content__title-button">Teleport</button></td></td>
				</tr>
				</tr>
			</table>
		</form>
