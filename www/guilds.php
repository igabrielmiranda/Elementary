...
if (isset($guilds) && !empty($guilds) && $guilds !== false) {
	...
	<?php 
} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><p>Guild list is empty.</p></div></div>';?>
...
if (user_logged_in() === true) {
						...
						if (get_character_guild_rank($user_id) < 1) {
							...
							// Only allow normal symbols as guild name
								...
								if ($gid === false) {
									...
									exit();
									} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style="">A guild with that name already exist.</div></div>';
								} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style="">Guild name is to long. It can has to be 30 or less characters long.</div></div>';
							} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style="">Guild name may only contain a-z, A-Z and spaces.</div></div>';
						} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style="">You are already in a guild.</div></div>';
					} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style="">You need a premium account to create a guild.</div></div>';
				} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style="">Your character must be offline to create a guild.';
			} else echo $name .' is level '. $char_data['level'] .'. But you need level '. $config['create_guild_level'] .'+ to create your own guild!</div></div>';
		}
	}
	// end
	?>
	...
	<form action="" method="post">
		<ul>
				...
				Create Guild:<br>
				<select style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;" name="selected_char">
				<?php
				...
				<input type="text" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;" name="guild_name">
				<input type="submit" class="btn yellow flex-cc header__info-button"  value="Create Guild">

		</ul>
	</form></div></div>

	<?php
} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style="">You need to be logged in to create guilds.</div></div>';
?>
<!-- end user-->
			...
			<tr class="yellow">
				...
				if ($inv_data !== false) foreach ($inv_data as $inv) {
					...
					?> <form action="" method="post"> <?php
						...
						echo '<input type="submit" class="btn yellow flex-cc header__info-button"  value="Remove Invitation">';
						echo '</td>';
					?> </form> <?php
					}
					// Join Guild
					?> <form action="" method="post"> <?php
						for ($i = 0; $i < $char_count; $i++) {
							if ($charactersId[$i] == $inv['player_id']) {
								...
								echo '<input type="submit" class="btn yellow flex-cc header__info-button"  value="Join Guild">';
								echo '</td>';
								$bool = true;
							}
						}
					...
					?> <form action="" method="post"> <?php
						for ($i = 0; $i < $char_count; $i++) {
							if ($charactersId[$i] == $inv['player_id']) {
								echo '<td>';
								echo '<input type="hidden" name="uninvite" value="' . $inv['player_id'] . '" />';
								echo '<input type="submit" class="btn yellow flex-cc header__info-button"  value="Reject Invitation">';
								echo '</td>';
								$bool = true;
							}
						}
	...
	if (user_logged_in() === true) {
		...
		if (!empty($_POST['joinguild'])) {
			...
			if ($join_account !== $session_user_id) {
				echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">Join guild request sent from wrong account.</font></div></div>';
					...
					if ($chardata['online'] == 0) {
						...
						if (get_character_guild_rank($joining_player_id) === false) {
							if (guild_player_join($joining_player_id, (int)$gid)) {
								header('Location: guilds.php?name='. $_GET['name']);
								exit();
							} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">Failed to find guild position representing member.</font></div></div>';
						
						} else {
							$already_guild = get_player_guild_data($joining_player_id);
							$already_guild_name = get_guild_name($already_guild['guild_id']);
							
							echo "<div class='global-desc__content' style='width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px'><div class='desc-changelog__block flex-ss'><font color='red' size='4'>You are already <strong>{$already_guild['rank_name']}</strong> of another guild: <strong><a href='guilds.php?name={$already_guild_name}'>{$already_guild_name}</a></strong>.<br>You need to leave that guild first before you can join another one.</font></div></div>";
						}

					} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">Character must be offline before joining guild.</font></div></div>';
				}
			}
		}
		...
		if (!empty($_POST['leave_guild'])) {
			...
			if ($leave_account !== $session_user_id) {
				echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">Leave guild request sent from wrong account.</font></div></div>';
				include 'layout/overall/footer.php';
				exit();
			}
			...
			if ($chardata['online'] == 0) {
				...
				header('Location: guilds.php?name='. $_GET['name']);
				exit();
			} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">Character must be offline first!</font></div></div>';
		}
					...
					if (preg_match("/^[a-zA-Z_ ]+$/", $_POST['guildnick']) || empty($_POST['guildnick'])) {
						...
						if ($p_guild['guild_id'] == $gid) {
							...
							if ($chardata['online'] == 0) {
								...
								header('Location: guilds.php?name='. $_GET['name']);
								exit();
							} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">Character not offline.</font></div></div>';
						}

					} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">Character guild nick may only contain a-z, A-Z and spaces.</font></div></div>';
				} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">Change guild nickname feature has been disabled.</font></div></div>';
			}
				...
				if (user_character_exist($_POST['invite'])) {
					...
					if (!$membership) {
						...
						if ($status == false) {
							...
							header('Location: guilds.php?name='. $_GET['name']);
							exit();
						} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">That character is already invited(or a member) on this guild.</font></div></div>';
					} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">That character is already in a guild.</font></div></div>';

				} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">That character name does not exist.</font></div></div>';
			}
			...
			if (!empty($_POST['forumGuildId'])) {
				...
				if ($config['forum']['guildboard'] === true) {
					...
					if ($forumExist === false) {
						...
						;");
						echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><h1>Guild board has been created.</h1></div></div>';
					} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><h1>Guild board already exist.</h1></div></div>';

				} else {
					echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><h1>Error: Guild board system is disabled.</h1></div></div>';
				}
			}
				...
				if (!empty($_POST['warinvite'])) {
					...
					if ($targetGuild) {
						...
						if ($status == false && $wars == false) {
							...
							header('Location: guilds.php?name='. $_GET['name']);
							exit();
						} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">This guild has already been invited to war(or you\'re trying to invite your own).</font></div></div>';

					} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">That guild name does not exist.</font></div></div>';
				}
				...
				if ($forumExist === false) {
					...
					<form action="" method="post">
						<ul>
							...
							<input type="submit" class="btn yellow flex-cc header__info-button"  value="Create Guild Board">
						</ul>
					</form></div></div>
					<?php
				}
				...
				<form action="" method="post" enctype="multipart/form-data">
					<ul>
						<li>Upload guild logo [.gif images only, 100x100px size]:<br>
							...
							<input type="submit" class="btn yellow flex-cc header__info-button"  name="submit" value="Upload guild logo">
						</li>
					</ul>
				</form></div></div>
				<?php
...
<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style="">
			...
			<form action="" method="post">
				<ul>
					<li>Invite Character to guild:<br>
						<input type="text" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;" name="invite" placeholder="Character name">
						<input type="submit" class="btn yellow flex-cc header__info-button"  value="Invite Character">
					</li>
				</ul>
			</form>
		</div></div>
			...
			<form action="" method="post">
				<ul>
					...
					<li>
						...
						<input type="submit" class="btn yellow flex-cc header__info-button"  value="Update guild message">
					</li>
				</ul>
			</form>
		</div></div>
				...
				<form action="" method="post">
					<ul>
						<li>
							...
							<select style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;" name="player_guildnick">
							<?php
							...
							<input type="text" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;" name="guildnick" maxlength="15" placeholder="leave blank to erase">
							<input type="submit" class="btn yellow flex-cc header__info-button"  value="Change Nick">
						</li>
					</ul>
				</form></div></div>
			<?php endif; ?>
				...
				<form action="" method="post">
					<ul>
						<li>
							...
							<select style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;" name="promote_character">
							<?php
							//$gid = get_guild_id($_GET['name']);
							//$players = get_guild_players($gid);
							foreach ($players as $player) {
							...
							<select style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;" name="promote_position">
								<?php
								foreach ($ranks as $rank) {
									if ($rank['level'] != 3) {
										if ($rank['level'] != 2) {
							...
							<input type="submit" class="btn yellow flex-cc header__info-button"  value="Promote Member">
						</li>
					</ul>
				</form></div></div>
				<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style="">
				...
				<form action="" method="post">
					<ul>
						<li>
							...
							<select style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;" name="remove_member">
								<?php
								//$gid = get_guild_id($_GET['name']);
								//$players = get_guild_players($gid);
								foreach ($players as $player) {
							...
							<input type="submit" class="btn yellow flex-cc header__info-button"  value="Remove member">
						</li>
					</ul>
				</form></div></div>
			<?php endif; ?>
		...
		if ($highest_access == 3) { 
			...
			if (!empty($_POST['disband'])) {
				...
				if (!$online) {
					...
					header('Location: success.php');
					exit();
				} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">All members must be offline to disband the guild.</font></div></div>';
			}
			...
			if (!empty($_POST['new_leader'])) {
				...
				if ($online == false) {
					if (guild_change_leader($new_leader, $old_leader)) {
						header('Location: guilds.php?name='. $_GET['name']);
						exit();
					} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">Something went wrong when attempting to change leadership.</font></div></div>';
				} else echo '<div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font color="red" size="4">The new and old leader must be offline to change leadership.</font></div></div>';
			}
			...
			<form action="" method="post">
				<ul>
					<li><b>Change rank titles:</b><br>
						...
						$rank_count = 1;
						foreach ($ranks as $rank) {
							echo '<input type="text" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;" name="rank_name!'. $rank['level'] .'" value="'. $rank['name'] .'">';
						}
						echo '<input type="hidden" name="change_ranks" value="' . $gid . '" />';
						?>
						<input type="submit" class="btn yellow flex-cc header__info-button"  value="Update Ranks">
					</li>
				</ul>
			</form>
					</div></div>
			...
			<form action="" method="post">
				<ul>
					<li><b>DELETE GUILD (All members must be offline):</b><br>
						...
						<input type="submit" class="btn yellow flex-cc header__info-button"  value="Disband Guild">
					</li>
				</ul>
			</form>
					</div></div>
				...
				<form action="" method="post">
					<ul>
						<li><b>Change Leadership with:</b><br>
							<select style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;" name="new_leader">
							<?php
							//$gid = get_guild_id($_GET['name']);
							//$players = get_guild_players($gid);
							foreach ($players as $player) {
							...
							<input type="submit" class="btn yellow flex-cc header__info-button"  value="Change Leadership">
						</li>
					</ul>
				</form></div></div>
			<?php endif; ?>
				...
				<form action="" method="post">
					<ul>
						<li>Invite guild to war:<br>
							<input type="text" style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;" name="warinvite" placeholder="Guild name">
							<input type="number" min="10" max="999" name="limit">
							<input type="submit" class="btn yellow flex-cc header__info-button"  value="Invite Guild">
						</li>
					</ul>
				</form>
			</div></div>
					...
					if (!empty($wars) || $wars !== false) {
						foreach($wars as $war): 
							...
							if ($war['guild1'] == $gid) {
								...
								$row .= '<input type="submit" class="btn yellow flex-cc header__info-button"  value="Cancel Invitation">';
								$row .= '</form>';
							} else if ($war['guild2'] == $gid) {
								$row .= '<br><form action="" method="post">';
								$row .= "<input type='hidden' name='accept_war_invite' value='{$war['guild1']}' />";
								$row .= '<input type="submit" class="btn yellow flex-cc header__info-button"  value="Accept Invitation">';
								$row .= '</form>';

								$row .= '<form action="" method="post">';
								$row .= "<input type='hidden' name='reject_war_invite' value='{$war['guild1']}' />";
								$row .= '<input type="submit" class="btn yellow flex-cc header__info-button"  ID="btnspace" value="Reject Invitation">';
								$row .= '</form>';
							}
							$row .= '</center></td>';
	...
	if (user_logged_in() === true) {
		...
		if ($bool) {
			$forumExist = mysql_select_single("SELECT `id` FROM `znote_forum` WHERE `guild_id`='{$gid}' LIMIT 1;");
			if ($forumExist !== false) {
				?> <div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style=""><font size="4"><a href="forum.php?cat=<?php echo $forumExist['id']; ?>">Visit Guild Board</a></font><br><br><br></div></div><?php
			}
			?><div class="global-desc__content" style="width:100%;margin-top:3px;margin-bottom:3px;padding-top:3px;padding-bottom:3px;padding-left:3px;padding-right:3px"><div class="desc-changelog__block flex-ss" style="">
			<form action="" method="post">
				<ul>
					<li>
						Leave Guild:<br>
						<select style="font-size:18px;color:white;background: rgba(14, 9, 8, 0.9);border: 1px solid #2d1f1e;" name="leave_guild">
						...
						<input type="submit"  value="Leave Guild" class="btn yellow flex-cc header__info-button">
					</li>
				</ul>
			</form></div></div>
		<?php
