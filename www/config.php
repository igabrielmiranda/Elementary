<?php
	...
	$config['site_title'] = 'Hellgrave Real Map Exodus';
	$config['site_title_context'] = 'Custom Tibia RPG Experience';
	$config['site_url'] = "";

	// Path to server folder without "\" (or "/") at the end, ex: C:\Users\Username\Documents\GitHub\forgottenserver
	$config['server_path'] = 'C:/Server/';
	...
	$config['sqlUser'] = 'ejemplotibia';

	// phpmyadmin password for OT server:
	$config['sqlPassword'] = '123456';

	// The database name to connect to. (This is usually same as username).
	$config['sqlDatabase'] = '1098znote';
	...
	*/
	...
	$config['show_outfits'] = array(
		...
		'imageServer' => 'https://hellgrave-exodus.com/outfits/animoutfit.php'
	);
	...
	*/
	...
	$config['shop'] = array(
		...
		'showImage' => true,
		'imageServer' => 'hellgrave-exodus.com/items',
		'imageType' => 'png',
	);
	...
	*/
	$config['shop_offers'] = array(
		1 => array(
			'type' => 5,
			'itemid' => [909, 910], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Shadowlotus Disciple outfit with both addons",
			'points' => 90,
		),
		2 => array(
			'type' => 5,
			'itemid' => [911, 912], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Ancient Aucar outfit with both addons",
			'points' => 120,
		),
		3 => array(
			'type' => 5,
			'itemid' => [913, 914], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Frost Tracer outfit with both addons",
			'points' => 120,
		),
		4 => array(
			'type' => 5,
			'itemid' => [915, 916], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Armoured Archer outfit with both addons",
			'points' => 90,
		),
		5 => array(
			'type' => 5,
			'itemid' => [917, 918], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Eternal Mage outfit with both addons",
			'points' => 110,
		),
		6 => array(
			'type' => 5,
			'itemid' => [919, 920], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Lion of War outfit with both addons",
			'points' => 180,
		),
		7 => array(
			'type' => 5,
			'itemid' => [921, 922], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Decaying Defender outfit with both addons",
			'points' => 150,
		),
		8 => array(
			'type' => 5,
			'itemid' => [923, 924], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Darklight Evoker outfit with both addons",
			'points' => 150,
		),
		9 => array(
			'type' => 5,
			'itemid' => [925, 926], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Flamefury Mage outfit with both addons",
			'points' => 100,
		),
		10 => array(
			'type' => 5,
			'itemid' => [972, 971], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Small Angel outfit with both addons",
			'points' => 110,
		),
		11 => array(
			'type' => 5,
			'itemid' => [974, 973], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Everblight outfit with both addons",
			'points' => 160,
		),
		12 => array(
			'type' => 5,
			'itemid' => [984, 985], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Herald outfit with both addons",
			'points' => 110,
		),
		13 => array(
			'type' => 5,
			'itemid' => [997, 998], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Battle mage outfit with both addons",
			'points' => 90,
		),
		14 => array(
			'type' => 5,
			'itemid' => [999, 1000], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Discoverer outfit with both addons",
			'points' => 90,
		),
		15 => array(
			'type' => 5,
			'itemid' => [1014, 1015], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Hand of Inquisition outfit with both addons",
			'points' => 100,
		),
		16 => array(
			'type' => 5,
			'itemid' => [1016, 1017], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Doom Knight outfit with both addons",
			'points' => 95,
		),
		17 => array(
			'type' => 5,
			'itemid' => [1037, 1038], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Poltergeist outfit with both addons",
			'points' => 95,
		),
		18 => array(
			'type' => 5,
			'itemid' => [1064, 1065], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Golden outfit with both addons",
			'points' => 180,
		),
		19 => array(
			'type' => 5,
			'itemid' => [1066, 1067], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Revenant outfit with both addons",
			'points' => 150,
		),
		20 => array(
			'type' => 6,
			'itemid' => 927, // Mount ID
			'count' => 1,
			'description' => "Darklight Devourer",
			'points' => 150,
		),
		21 => array(
			'type' => 6,
