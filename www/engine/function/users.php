...
function user_create_account($register_data, $maildata) {
	...
	$register_data['premium_ends_at'] ='1706957777';
...
function user_create_character($character_data) {
	...
	if ($cnf['ServerEngine'] === 'TFS_10') {
		...
		$import_data['ancestral_rank_points'] = $skills['ancestral_rank_points'];
	}
	...
	if ($cnf['ServerEngine'] != 'TFS_10') {
		...
		mysql_insert("INSERT INTO `player_skills` (`player_id`, `skillid`, `value`) VALUES ('{$charid}', '0', '".$skills['fist']."'), ('{$charid}', '1', '".$skills['club']."'), ('{$charid}', '2', '".$skills['sword']."'), ('{$charid}', '3', '".$skills['axe']."'), ('{$charid}', '4', '".$skills['dist']."'), ('{$charid}', '5', '".$skills['shield']."'), ('{$charid}', '6', '".$skills['fishing']."'), ('{$charid}', '7', '".$skills['ancestral_rank_points']."');");
	}
}
