...
function init()
  ...
  if not inventoryWindow.forceOpen then
    inventoryButton = modules.client_topmenu.addRightGameToggleButton('inventoryButton', tr('Inventory') .. ' (Ctrl+I)', '/images/topbuttons/login', toggle)
...
function hasStatus(id)
  return conditionPanel:getChildById(id)
end
