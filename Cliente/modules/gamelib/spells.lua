...
SpellInfo = {
  ['Default'] = {
    ...
    ['Flecha Congelante'] =        {id = 269, words = 'flecha congelante',     exhaustion = 10000, premium = false, type = 'Instant', icon = 'icicle',                 mana = 20,     level = 1,  soul = 0, group = {[1] = 2000},               vocations = {1, 2, 3, 4, 5, 6, 7, 8}, needWeapon = true, requiredWeaponType = 'bow', requiredItemName = 'Bow', description = 'Dispara uma flecha congelante que nao causa dano, mas congela/stuna o alvo por 2 segundos.', needTarget = true, range = 7, aggressive = true},
