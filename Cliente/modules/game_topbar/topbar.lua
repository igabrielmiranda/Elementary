...
local function positionTopBar()
    ...
    topBar:removeAnchor(AnchorLeft)
    topBar:removeAnchor(AnchorRight)
    topBar:removeAnchor(AnchorTop)
    topBar:removeAnchor(AnchorBottom)
    topBar:removeAnchor(AnchorHorizontalCenter)
    topBar:removeAnchor(AnchorVerticalCenter)
    topBar:addAnchor(AnchorHorizontalCenter, 'gameBottomActionPanel',
                     AnchorHorizontalCenter)
    topBar:addAnchor(AnchorBottom, 'gameBottomActionPanel', AnchorTop)
    topBar:setMarginLeft(0)
    topBar:setMarginTop(0)
    topBar:setMarginBottom(COMPACT_TOPBAR_MARGIN_BOTTOM)
    topBar:raise()
end
...
function setupTopBar()
    ...
    topBar:setWidth(COMPACT_TOPBAR_WIDTH)
    topBar.stats:setWidth(COMPACT_TOPBAR_CONTENT_WIDTH)
    topBar.skills:setWidth(COMPACT_TOPBAR_CONTENT_WIDTH)
    positionTopBar()
...
function setSkillsLayout()
    ...
    local width = math.max(skills:getWidth(), COMPACT_TOPBAR_CONTENT_WIDTH)
    ...
    skills:getLayout():setCellSize({width = width, height = COMPACT_SKILL_PANEL_HEIGHT})
end
