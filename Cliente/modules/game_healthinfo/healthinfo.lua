...
topHealthBar = nil
topManaBar = nil
local COMPACT_OVERLAY_BAR_WIDTH = 170
local COMPACT_OVERLAY_BAR_HEIGHT = 12
local COMPACT_OVERLAY_BAR_LEFT = 8
local COMPACT_OVERLAY_BAR_TOP = 32
local COMPACT_OVERLAY_BAR_SPACING = 2

local function refreshTopBarsVisibility()
...
function init()
  ...
  setupCompactOverlayBars()
  refreshTopBarsVisibility()
...
function setupCompactOverlayBars()
  topHealthBar:removeAnchor(AnchorRight)
  topHealthBar:addAnchor(AnchorLeft, 'parent', AnchorLeft)
  topHealthBar:addAnchor(AnchorTop, 'parent', AnchorTop)
  topHealthBar:setWidth(COMPACT_OVERLAY_BAR_WIDTH)
  topHealthBar:setHeight(COMPACT_OVERLAY_BAR_HEIGHT)
  topHealthBar:setMarginLeft(COMPACT_OVERLAY_BAR_LEFT)

  topManaBar:removeAnchor(AnchorLeft)
  topManaBar:removeAnchor(AnchorRight)
  topManaBar:removeAnchor(AnchorTop)
  topManaBar:addAnchor(AnchorLeft, 'parent', AnchorLeft)
  topManaBar:addAnchor(AnchorTop, 'topHealthBar', AnchorBottom)
  topManaBar:setWidth(COMPACT_OVERLAY_BAR_WIDTH)
  topManaBar:setHeight(COMPACT_OVERLAY_BAR_HEIGHT)
  topManaBar:setMarginLeft(COMPACT_OVERLAY_BAR_LEFT)
  topManaBar:setMarginTop(COMPACT_OVERLAY_BAR_SPACING)
end
...
function onOverlayGeometryChange() 
  ...
  if classic then
    topHealthBar:setMarginTop(8)
  else
    topHealthBar:setMarginTop(COMPACT_OVERLAY_BAR_TOP - overlay:getParent():getMarginTop())
  end
  topHealthBar:setMarginLeft(COMPACT_OVERLAY_BAR_LEFT)
  topManaBar:setMarginLeft(COMPACT_OVERLAY_BAR_LEFT)
  topManaBar:setMarginTop(COMPACT_OVERLAY_BAR_SPACING)
